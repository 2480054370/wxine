 ...
 * @author guolin
 */
public class PhotosDetailsActivity extends Activity implements
	...
	class ViewPagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, int position) {
			...
			View view = LayoutInflater.from(PhotosDetailsActivity.this).inflate(
					R.layout.activity_photos_view, null);
			PhotosView PhotosView = (PhotosView) view
					.findViewById(R.id.zoom_image_view);
			PhotosView.setImageBitmap(bitmap);
