 ...
 * @author guolin
 */
public class PhotosScrollView extends ScrollView implements OnTouchListener {
	...
	private static Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			PhotosScrollView PhotosScrollView = (PhotosScrollView) msg.obj;
	 ...
	 * @param attrs
	 */
	public PhotosScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
			...
			if (mImageView != null) {
				...
				imageView.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						Intent intent = new Intent(getContext(), PhotosDetailsActivity.class);
