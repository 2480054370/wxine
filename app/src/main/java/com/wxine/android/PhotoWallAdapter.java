...
public class PhotoWallAdapter extends ArrayAdapter<String> implements OnScrollListener {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View view;
		if (convertView == null) {
			view = LayoutInflater.from(getContext()).inflate(R.layout.activity_img_img_item, null);
		} else {
			view = convertView;
		}
		final ImageView photo = (ImageView) view.findViewById(R.id.iv_head);
		AbsListView.LayoutParams lpRef = new AbsListView.LayoutParams(120, 120);
		photo.setLayoutParams(lpRef);
